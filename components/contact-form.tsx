...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setStatus({ submitted: false, submitting: true, error: false, success: false });
  ...
  return (
    <section className="relative mt-32">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 dark:text-white">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12 backdrop-blur-sm border border-gray-100 dark:border-gray-700">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent transition-all duration-200"
            ...
            <div>
              <label htmlFor="interest" className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
                I am interested as
              </label>
              <select
                name="interest"
