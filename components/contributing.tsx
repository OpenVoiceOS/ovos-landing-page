...
const featuresData = [
  {
    title: "Coding",
    description:
      "Developers of all backgrounds are welcome, from front-end and backend to machine learning and voice recognition. Help by improving features, fixing bugs, or optimizing performance to keep the platform robust and accessible.",
    icon: (
      <svg
        width="64px"
        height="64px"
  ...
  },
  {
    ...
    description:
      "Create new skills and plugins, or improve existing ones, to expand what OpenVoiceOS can do and offer users more personalized interactions.",
    icon: (
      <svg
        width="64px"
        height="64px"
  ...
  },
  {
    ...
    description:
      "We want no language left behind. Help translate OpenVoiceOS so people around the world can use it in their native language.",
    icon: (
      <svg
        width="64px"
        height="64px"
  ...
  },
  {
    title: "Documentation",
    description:
      "Good documentation guides users through setup and helps developers build skills and plugins. Whether you're a writer or know OpenVoiceOS well, help keep our docs clear and up to date.",
    icon: (
      <svg
        width="64px"
        height="64px"
  ...
  },
  {
    ...
    description:
      "Help grow the community by spreading the word through social media, blogs, forums, and developer circles to attract new users and contributors.",
    icon: (
      <svg
        width="64px"
        height="64px"
  ...
  },
  {
    title: "Donating",
    description:
      "Donations cover server costs, development tools, and other resources that keep the project running. One-time or ongoing, every contribution helps OpenVoiceOS thrive.",
    icon: (
      <svg
        fill="#000000"
        width="64px"
...
const Contributions = () => {
  return (
    <section className="relative mt-32">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base lg:mx-auto">
            OpenVoiceOS is an open-source voice assistant built by a passionate
            community of developers, translators, testers, and advocates.
            Whether you code, translate, write docs, spread the word, or donate,
            your contribution helps build a customizable, privacy-focused, and
            inclusive voice assistant for everyone.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 sm:px-6 my-8">
      ...
      <div className="mt-20 bg-gray-50 dark:bg-gray-900 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
