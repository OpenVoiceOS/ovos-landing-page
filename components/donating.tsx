...
const featuresData = [
  {
    ...
    description:
      "Donate via PayPal for a one-time contribution or set up a recurring donation. This option provides the flexibility to choose the amount you want to give.",
    icon: (
      <svg
        width="64px"
        height="64px"
    ...
    url: "https://www.paypal.com/paypalme/openvoiceos",
  },
  {
    title: "Support us on Patreon",
    description:
      "Support us on Patreon and gain access to exclusive content, updates, and rewards based on your subscription tier. Patreon allows for monthly recurring donations, perfect for ongoing support.",
    icon: (
      <svg
        width="64px"
        height="64px"
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          {" "}
          <circle cx="512" cy="512" r="512" fill="#ff424d"></circle>{" "}
          <path
    ...
    url: "https://www.patreon.com/c/openvoiceos",
  },
  {
    title: "Donate via Liberapay",
    description:
      "Liberapay is a platform for recurring donations with no fees for the donor. You can set up a weekly, monthly, or yearly donation to support our continuous efforts.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        ></g>
        <g id="SVGRepo_iconCarrier">
          <rect width="512" height="512" rx="15%" fill="#f6c915"></rect>
          <path
            fill="#ffffff"
    ...
    url: "https://liberapay.com/OpenVoiceOS-Foundation",
  },
  {
    title: "GitHub Sponsor",
    description:
      "If you're active on GitHub, you can sponsor OpenVoiceOS directly through GitHub Sponsors. Choose a sponsorship tier that fits your budget and support us directly on the platform.",
    icon: (
      <svg
        width="64px"
        height="64px"
    ...
    url: "https://github.com/sponsors/OpenVoiceOS/",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base lg:mx-auto">
            Your donations are crucial in sustaining the OpenVoiceOS project.
            The funds are used to facilitate software development, acquire and
            test hardware, maintain infrastructure, and promote the project to
            reach a broader audience. Additionally, donations help cover the
            costs of providing user support and ensuring the platform's
            continuous improvement. Every contribution, no matter the size,
            plays a significant role in keeping OpenVoiceOS thriving and
            evolving.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 sm:px-6 my-8">
