        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          <div>
            ...
            <p className="text-lg rounded-xl p-3 max-w-2xl mx-auto text-gray-600 mb-8 dark:text-gray-300" data-aos="zoom-y-out">
              Interested in building your own Voice Assistant? Check out <Link href="https://community.openconversational.ai/t/howto-begin-your-open-voice-os-journey-with-the-ovos-installer/14900" className='text-blue-800'>this</Link> amazing guide to get started.
            </p>
