        ...
        <div className="py-12 md:py-5">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-2 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 text-gray-800 dark:text-white">
                Community Driven
              </h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Embedded headless device or single board computers with screens
                to build a do-it-yourself smart speaker, Open Voice OS is the
                open community playground for all platforms to come and
                experiment at.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Have an experimental feature you want users to experience before
                landing them into any of the Linux-based open-source voice
                assistant projects upstream? Open Voice OS is the platform.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                Open Voice OS being a community platform is open to all
                developers and contributors wanting to support a specific device
                or a platform.
              </p>
            </div>
          </div>
