...
const friends = [
  {
    name: "HiveMind",
    description:
      "HiveMind is a community-developed superset or extension of OpenVoiceOS. With HiveMind, you can extend one (or more, but usually just one!) instance of OpenVoiceOS to as many devices as you want, including devices that can't ordinarily run OVOS!",
  ...
  },
  {
    name: "Smart'Gic",
    description:
      "Building smart things with magic and love! We have Smart'Gic to thank for our ovos-installer and ovos-docker",
  ...
  },
  {
    ...
    description:
      "Visio offers information and advice, but also various forms of research, guidance, rehabilitation, education, work and living. These services are available for people who are visually impaired or blind, even if they also have an intellectual, physical or other sensory disability.",
  ...
  },
  {
    name: "Mycroft",
    description:
      "Mycroft AI started it all, it was one of the first ever FOSS voice assistants and is the project OVOS descends from. Most applications made for mycroft will work in OVOS and vice-versa.",
        ...
        <div className="py-1 md:py-2">
          <div className="max-w-6xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4 dark:text-gray-300">
              Friends of Open Voice OS
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400 pb-5">
              OpenVoiceOS collaborates with a wide range of projects within the
              FOSS voice technology ecosystem. Explore our friends and their
              contributions below.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {friends.map((friend, index) => (
              <div
                key={index}
                className="flex flex-col rounded-lg shadow-lg p-6 bg-gray-200 dark:bg-gray-800"
              >
