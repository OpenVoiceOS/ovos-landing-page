    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div className="mx-auto mb-8 max-w-screen-xl lg:mb-16">
        ...
        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-300">
          A big shoutout to our community members for their invaluable
          contributions to the project! They have been instrumental in
          maintaining the core components of OVOS and hosting public servers for
      ...
      <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <Link href={`https://github.com/${member.handle}`}>
              @{member.handle}
            </Link>
          </div>
        ))}
