            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <Link className="btn font-bold text-white bg-black dark:bg-gray-800 dark:text-gray-200 rounded-3xl mx-auto" data-aos="zoom-y-out" data-aos-delay="300" href="/about">About Us</Link>
                </div>
