      ...
      <div className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 md:px-12 xl:px-32">
          <div className="mb-16 text-center">
            ...
            <p className="text-gray-600 lg:w-8/12 lg:mx-auto"> Open Voice OS is maintained by a small team of developers and lots of contributors. </p>
          </div>
          <div className="grid gap-12 items-center md:grid-cols-3">
            <div className="space-y-4 text-center">
              ...
              <div>
                <h4 className="text-2xl">Daniel McKnight</h4>
            ...
            <div className="space-y-4 text-center">
              ...
              <div>
                <h4 className="text-2xl">Casimiro Ferreira</h4>
                <span className="block text-sm text-gray-500">Code Wrangler / Maintainer OVOS Core</span>
              </div>
              <div className="flex justify-center space-x-4">
            ...
            <div className="space-y-4 text-center">
              ...
              <div>
                <h4 className="text-2xl">Peter Steenbergen</h4>
